...
${OBJECTDIR}/Lib/SocketClient.o: Lib/SocketClient.cpp
	${MKDIR} -p ${OBJECTDIR}/Lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Lib/SocketClient.o Lib/SocketClient.cpp
